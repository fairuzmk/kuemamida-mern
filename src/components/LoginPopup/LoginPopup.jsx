    ...
    <div className="login-popup">
        <form onSubmit={onLogin} action="" className="login-popup-container">
            <div className="login-popup-title">
                <h2>{currState}</h2>
                <span className="svg-login-icon"  onClick={()=>setShowLogin(false)}><FontAwesomeIcon icon={faXmark}/></span>
            </div>
            <div className="login-popup-inputs">
                ...
                {currState==="Login"
                ?<></>
                :<input type="text" name="phone" onChange= {onChangeHandler} value={data.phone} placeholder='No HP Kamu' required/>}
